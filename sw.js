...
async function p(e, n) {
    let r = null;
    if (e.url && (r = new URL(e.url).origin),
...
var C = class {
    ...
    async fetch(e) {
        ...
        try {
            ...
            for (let t of this.iterateCallbacks(`fetchDidSucceed`))
                e = await t({
                    event: n,
                    request: a,
                    response: e
    ...
    async cacheMatch(e) {
        let t = S(e), n, {cacheName: r, matchOptions: i} = this._strategy, a = await this.getCacheKey(t, `read`), o = Object.assign(Object.assign({}, i), {
            cacheName: r
        });
        n = await caches.match(a, o);
        for (let e of this.iterateCallbacks(`cachedResponseWillBeUsed`))
            n = await e({
                cacheName: r,
                matchOptions: i,
                cachedResponse: n,
    ...
    async cachePut(e, n) {
        ...
        if (!a)
            return !1;
        let {cacheName: o, matchOptions: s} = this._strategy
          , c = await self.caches.open(o)
          , l = this.hasCallback(`cacheDidUpdate`)
          , u = l ? await g(c, i.clone(), [`__WB_REVISION__`], s) : null;
        try {
            await c.put(i, l ? a.clone() : a)
        } catch (e) {
            if (e instanceof Error)
                throw e.name === `QuotaExceededError` && await b(),
                e
        }
    ...
    async runCallbacks(e, t) {
        for (let n of this.iterateCallbacks(e))
            await n(t)
    }
    *iterateCallbacks(e) {
        for (let t of this._strategy.plugins)
    ...
    async doneWaiting() {
        for (; this._extendLifetimePromises.length; ) {
            let e = this._extendLifetimePromises.splice(0)
              , t = (await Promise.allSettled(e)).find(e => e.status === `rejected`);
            if (t)
                throw t.reason
        }
    }
  ...
  , T = class e extends w {
    ...
    async _handleFetch(e, n) {
        ...
        if (this._fallbackToNetwork) {
            ...
            r = await n.fetch(new Request(e,{
                integrity: e.mode === `no-cors` ? void 0 : a || t
            })),
            t && o && e.mode !== `no-cors` && (this._useDefaultCacheabilityPluginIfNeeded(),
            await n.cachePut(e, r.clone()))
        } else
    ...
    _useDefaultCacheabilityPluginIfNeeded() {
        ...
        for (let[r,i] of this.plugins.entries())
            i !== e.copyRedirectedCacheableResponsesPlugin && (i === e.defaultPrecacheCacheabilityPlugin && (t = r),
            i.cacheWillUpdate && n++);
...
var E = class {
    ...
    addToCacheList(e) {
        ...
        for (let r of e) {
            ...
            if (this._urlsToCacheKeys.set(i, e),
    ...
    install(e) {
        return o(e, async () => {
            ...
            for (let[t,n] of this._urlsToCacheKeys) {
                let r = this._cacheKeysToIntegrities.get(n)
...
, M = class {
        ...
        self.addEventListener(`message`, (e => {
            if (e.data && e.data.type === `CACHE_URLS`) {
                let {payload: t} = e.data
                  , n = Promise.all(t.urlsToCache.map(t => {
                    typeof t == `string` && (t = [t]);
                    let n = new Request(...t);
    ...
    handleRequest({request: e, event: t}) {
        ...
        if (!n.protocol.startsWith(`http`))
            return;
        let r = n.origin === location.origin
          ...
          , o = a && a.handler
          , s = e.method;
        if (!o && this._defaultHandlerMap.has(s) && (o = this._defaultHandlerMap.get(s)),
        !o)
            return;
        let c;
        try {
...
V([{
    ...
    "revision": null,
    "url": "index-DGyHmZfC.css"
}, {
    "revision": null,
    "url": "index-CDIAH__g.js"
}, {
    "revision": "eaef5e740ca99081bc4328ab32e94216",
    "url": "android-chrome-192x192.png"
}, {
    "revision": "442ccfa398b91aefb1b2f16f8b634af6",
    "url": "android-chrome-512x512.png"
}, {
    "revision": "d6710c1942c0e5f0919fe5e615c4249a",
    "url": "apple-touch-icon.png"
}, {
    "revision": "88a32cc76ee77b66677148f260377160",
    "url": "favicon.ico"
}, {
    "revision": "122414dca0320019735ee8fb507af4ca",
